    ...
    public function store(Request $request)
    {
        // try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'is_usg_show' => 'required|boolean',
                'is_brand_show' => 'required|boolean',
                'is_tiktok' => 'required|boolean',
                'is_instagram' => 'required|boolean',
                'is_youtube' => 'required|boolean',
                'is_sent_to_content_creator' => 'required|boolean', 
            ...
            $item = Campaign::create([
                ...
                'product_image' => getRelative($request->product_image),
